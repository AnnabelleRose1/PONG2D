...
public class Window extends JFrame implements Runnable{
    ...
    public Window() {
        ...
        // Score on screen
        leftScoreText = new Text(0,new Font("Times New Roman", Font.BOLD,Constants.TEXT_SIZE),Constants.TEXT_X_POS,Constants.TEXT_Y_POS);
        rightScoreText = new Text(0, new Font("Times New Roman", Font.BOLD,Constants.TEXT_SIZE),Constants.SCREEN_WIDTH -Constants.TEXT_X_POS - 16, Constants.TEXT_Y_POS);
